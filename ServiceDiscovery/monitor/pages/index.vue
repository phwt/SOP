  ...
  <div>
    ...
    <div class="hero bg-white overflow-hidden">
      <div class="hero-inner align-self-stretch d-flex flex-column">
        ...
        <div
          class="content content-full flex-fill d-flex align-items-center px-lg-6 px-xl-8 overflow-hidden"
        >
          <b-row class="w-100">
            <b-col
              lg="6"
            ...
            >
              <div class="w-100">
                ...
                <p class="font-size-lg font-w500 text-muted mb-4">
                  ...
                  <a href="https://1.envato.market/AVD6j">OneUI Remastered</a>
                  design! - {{ env }}
                </p>
                <b-button
                  variant="success"
                  class="text-uppercase font-size-sm px-4 py-2 mr-2 mt-2"
          ...
          <b-row class="mb-5">
            <b-col md="6">
              ...
              <p class="font-size-lg font-w500 text-muted mb-0">
                We used the best toolkits, built by passionate people, to
            ...
            >
              <p class="h1 font-w700 text-body-bg-dark mb-0">Get Inspired.</p>
            </b-col>
          </b-row>
          <b-row>
            <b-col
              ...
              <div>
                <div class="d-flex push">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-muted">
                      Standard tooling for Vue.js development. Out-of-the-box
                      support for Babel, TypeScript, ESLint, PostCSS, PWA, Unit
                ...
                <div class="d-flex push">
                  ...
                  <div class="ml-4">
                    ...
                    <p class="text-muted">
                      You can build responsive, mobile-first, and ARIA
                      accessible projects on the web using Vue.js and the
                      world's most popular front-end CSS library — Bootstrap 4.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="py-5">
          <b-row class="mb-5">
            ...
            <b-col
              ...
              class="d-none d-md-flex align-items-md-center justify-content-md-end"
            >
              <p class="h1 font-w700 text-body-bg-dark mb-0">Fully Loaded.</p>
            </b-col>
          </b-row>
          <b-row>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                The latest Bootstrap version powers the framework. Flexbox
                support and tons of new features are ready for you to use.
              </p>
              <!-- END Bootstrap 4 -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                Sass is used to override and extent Bootstrap in an intelligent
                way to ensure a perfect and modular workflow.
              </p>
              <!-- END Sass -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
            ...
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                The latest Font Awesome version is available, bringing you over
                1300 freshly made icons to be used in your projects.
              </p>
              <!-- END FontAwesome 5 -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                Babel makes your JS code compatible with older browsers and
                webpack bundles your asset files together. Works out-of-the-box
                with Vue CLI.
              </p>
              <!-- END webpack -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                Develop and manage your projects through an accompanying
                graphical user interface. Perfect for managing your tasks &amp;
                dependencies.
              </p>
              <!-- END User Interface -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                When you edit a .vue file, all instances of that component will
                be swapped in without reloading the page. It also preserves
                current state.
              </p>
              <!-- END Hot Reload -->
            </b-col>
            ...
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                ...
                templates, making it easier to structure your page content.
              </p>
              <!-- END Components -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                Using the latest styles from OneUI Remastered version, you can
                be sure that all design elements are available in the Vue
                Edition as well.
              </p>
            ...
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                Dark header, light sidebar, flexbox based layout, page overlay,
                header search and even more layout features are all available.
              </p>
              <!-- END Layout Features -->
            </b-col>
            <b-col sm="6" md="4" xl="3">
              ...
              <p class="text-muted">
                ...
                component in your application. Either with buttons or JS code.
              </p>
              <!-- END APIs -->
            </b-col>
          </b-row>
        ...
        <div class="content content-full content-boxed">
          <div class="py-5 text-center">
            ...
            <p class="font-size-lg text-white-50 mb-6 mx-sm-6 mx-lg-9">
              <a class="text-primary-light" href="https://1.envato.market/AVD6j"
                >OneUI</a
              >
              is one of the Best Seller and Best Rated admin templates on
              Themeforest. Its success made possible the development of Vue
              Edition.
            </p>
            <b-row no-gutters class="mx-lg-8">
              <b-col sm="4" class="p-3">
                <p class="font-size-h1 font-w700 text-white-75 mb-0">4.000+</p>
                <p class="font-size-lg text-white-50 mb-0">Purchases</p>
              </b-col>
              <b-col sm="4" class="p-3">
                <p class="font-size-h1 font-w700 text-white-75 mb-0">250+</p>
                <p class="font-size-lg text-white-50 mb-0">5 Star Ratings</p>
              </b-col>
              <b-col sm="4" class="p-3">
                <p class="font-size-h1 font-w700 text-white-75 mb-0">21</p>
                <p class="font-size-lg text-white-50 mb-0">Free Updates</p>
              </b-col>
            </b-row>
          </div>
        </div>
      ...
      <div class="content content-full content-boxed">
        <div class="py-5 py-md-8 text-center">
          <h2 class="font-w700 mb-2">
            Crafted with <i class="fa fa-fw fa-heart text-city"></i> by
          ...
          <b-button
            variant="success"
            class="text-uppercase font-size-sm px-4 py-2 m-1"
            href="https://1.envato.market/5Noyb"
            v-click-ripple
          >
            <i
          ...
          <b-button
            ...
            v-click-ripple
          >
            <i class="fa fa-fw fa-rocket font-size-base opacity-50 mr-1"></i>
            Live Preview
          </b-button>
        </div>
      </div>
      ...
      <div class="content content-boxed py-5">
        <b-row class="font-size-sm font-w500">
          <b-col sm="6" order-sm="2" class="py-1 text-center text-sm-right">
            ...
            <a class="font-w600" href="https://1.envato.market/5Noyb"
              >pixelcave</a
            >
          </b-col>
